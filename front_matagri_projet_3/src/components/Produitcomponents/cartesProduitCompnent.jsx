import MaterielFilter from "./materiels";
                  ...
                  <div className="page-main-content">
                    <div className="top-banner-wrapper">
                      ...
                      <div className="top-banner-content small-section">
                        ...
                        <p>
                          The trick to choosing the best wear for yourself is to
                          keep in mind your body type, individual style,
                          occasion and also the time of day or weather. In
                          addition to eye-catching products from top brands, we
                          also offer an easy 30-day return and exchange policy,
                          free and fast shipping across all pin codes, cash or
                          card on delivery option, deals and discounts, among
                          other perks. So, sign up now and shop for westarn wear
                          to your heart’s content on Multikart.{" "}
                        </p>
                      </div>
                    </div>
          ...
          <ul>
            ...
            <li className="demo-li">
              <div className="backend-btn">
                <a target="_blank" href="../back-end/index.html">
                  Admin
                </a>
              </div>
            </li>
            ...
            <div className="setting_box_body">
              <div onclick="closeSetting()">
                <div className="sidebar-back text-start">
                  <i className="fa fa-angle-left pe-2" aria-hidden="true" />{" "}
                  Back
                </div>
              </div>

...
function Devis({ listMatPanier }) {
  ...
  const [prixtotaldevis, SetPrixtotaldevis] = useState("");
  const [listMat, SetListMat] = useState([]);

  useEffect(() => {}, [SetListMat([])]);
  return (
    <div>
                  ...
                  <table className="table table-borderless mb-0">
                    ...
                    <tbody>
                      {listMat.map((mat) => (
                        <tr>
                          <td>
                            <a type="text" value={mat.nommat} />
                          </td>
                          <td>
                            <a type="text" value={mat.description} />
                          </td>
                          <td>
                            <a type="text" value={mat.quantite} />
                          </td>
                          <td>
                            <a type="text" value={mat.prixunitaire} />
                          </td>
                          <td>
                            <a type="text" value={mat.datedebut} />
                          </td>
                          <td>
                            <a type="text" value={mat.datefin} />
                          </td>
                          <td>
                            <a type="text" value={mat.prixtotal} />
                          </td>
                        </tr>
                      ))()}
                      {/* <tr>
                        <td>
                          <a type="text" value={nommat} />
                        </td>
                        <td>
                          <a type="text" value={description} />
                        </td>
                        <td>
                          <a type="text" value={quantite} />
                        </td>
                        <td>
                          <a type="text" value={prixunitaire} />
                        </td>
                        <td>
                          <a type="text" value={datedebut} />
                        </td>
                        <td>
                          <a type="text" value={datefin} />
                        </td>
                        <td>
                          <a type="text" value={prixtotal} />
                        </td>
                      </tr> */}
                    </tbody>
                    <tfoot>
                      <tr>
                        ...
                        <td className="font-bold text-theme">
                          <a type="text" value={prixtotaldevis} />
                        </td>
                      </tr>
                    </tfoot>
                  </table>

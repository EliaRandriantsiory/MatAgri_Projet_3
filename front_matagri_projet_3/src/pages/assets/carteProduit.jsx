                  ...
                  <div className="img-wrapper">
                        ...
                        <div className="front">
                          <a href="#">
                            ...
                            <img
                              src={`${process.env.PUBLIC_URL}/assets/images/materiels/${JSON.parse(matHomePage.imagePath)[0]}`}
                              width={500}
                        ...
                        <div className="back">
                          <a href="#">
                          <img
                              src={`${process.env.PUBLIC_URL}/assets/images/materiels/${JSON.parse(matHomePage.imagePath)[1]}`}
                              width={500}
                              className="img-fluid blur-up lazyload bg-img"
                            />
                          </a>

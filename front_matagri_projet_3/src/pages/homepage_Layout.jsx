    ...
    return ( 
        <>
            ...
            <div className="container">
                ...
                <div className="col-sm-12">
                    ...
                    <div className="menu-left">
                        ...
                        <Link to="/" > <img src="assets/images/icon/logo/Logo-_Mat_2.png" className="img-fluid blur-up lazyload logoHomePage" alt=""   /></Link>
                        </div>
                    </div>
                    <div className="menu-right pull-right">
                        ...
                        <nav id="main-nav">
                            ...
                            <li>
                                <div className="mobile-back text-end">Retour<i className="fa fa-angle-right ps-2" aria-hidden="true" /></div>
                            </li>
                                ...
                                <li>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="link-section">
                                            ...
                                            <div className="menu-content">
                                            <ul>
                                                <li><a href="index.html">bottom<i className="ms-2 fa fa-bolt icon-trend" aria-hidden="true" /></a></li>
                                            ...
                                            <ul>
                                                <li><a href="marketplace-demo-2.html">ajax
                                                    search<i className="ms-2 fa fa-bolt icon-trend" aria-hidden="true" /></a></li>
                                            </ul>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div className="link-section">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="index.html">exit<i className="ms-2 fa fa-bolt icon-trend" aria-hidden="true" /></a></li>
                                        ...
                                        <div className="link-section">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="vegetables.html">qty. counter
                                                    <i className="fa fa-bolt icon-trend" aria-hidden="true" /></a></li>
                        ...
                        <div className="icon-nav">
                            <ul>
                            <li className="mobile-wishlist"><a href="#"><img src="../assets/images/jewellery/icon/heart.png" className="opacity-1" alt="" /> </a></li>
                            ...
                            <li className="onhover-div mobile-search">
                                <div><img src="../assets/images/jewellery/icon/search.png" onclick="openSearch()" className="img-fluid blur-up lazyload" alt="" />
                            ...
                            <li className="onhover-div mobile-setting">
                                <div><img src="../assets/images/jewellery/icon/controls.png" className="img-fluid blur-up lazyload" alt="" />
                            ...
                            <li className="onhover-div mobile-cart">
                                <div><img src="../assets/images/jewellery/icon/cart.png" className="img-fluid blur-up lazyload" alt="" />
                ...
                <section className="small-section border-section border-top-0">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div>
                            ...
                            <p>Ne manquez rien de MatAgri en vous inscrivant à notre newsletter.</p>
                        </div>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        ...
                        <div className="form-group mx-sm-3">
                            <input type="text" className="form-control" name="EMAIL" id="mce-EMAIL" placeholder="Entrer votre mail" required="required" />
                        </div>
                        <button type="submit" className="btn btn-solid" id="mc-submit">souscrire</button>
                        </form>
                    </div>
                    </div>
                </section>
            ...
            <section className="section-b-space light-layout">
                ...
                <div className="row footer-theme partition-f">
                    ...
                    <div className="footer-contant">
                        <div className="footer-logo"><img src="../assets/images/icon/" alt="" /></div>
            ...
            <ul>
                ...
                <input id="ColorPicker1" type="color" defaultValue="#d4b196" name="Background" />
                </li>
            </ul>
            </div>
            ...
            <div className="modal fade bd-example-modal-lg theme-modal cart-modal" id="addtocart" tabIndex={-1} role="dialog" aria-hidden="true">
            <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div className="modal-body modal1">
                    ...
                    <div className="row">
                        ...
                        <div className="modal-bg addtocart">
                            ...
                            <div className="media">
                            <a href="#">
                                <img className="img-fluid blur-up lazyload pro-img" src="../assets/images/fashion/product/43.jpg" alt="" />
                            </a>
                            <div className="media-body align-self-center text-center">
                                ...
                                <div className="buttons">
                                <a href="#" className="view-cart btn btn-solid">Your cart</a>
                                <a href="#" className="checkout btn btn-solid">Check out</a>
                                <a href="#" className="continue btn btn-solid">Continue shopping</a>
                                </div>
                                <div className="upsell_payment">
                                <img src="../assets/images/payment_cart.png" className="img-fluid blur-up lazyload" alt="" />
                                </div>
                            </div>
                            </div>
                            ...
                            <div className="row" id="upsell_product">
                                ...
                                <div className="img-wrapper">
                                    <div className="front">
                                    <a href="#">
                                        <img src="../assets/images/fashion/product/1.jpg" className="img-fluid blur-up lazyload mb-1" alt="cotton top" />
                                    </a>
                                    </div>
                                ...
                                <div className="img-wrapper">
                                    <div className="front">
                                    <a href="#">
                                        <img src="../assets/images/fashion/product/34.jpg" className="img-fluid blur-up lazyload mb-1" alt="cotton top" />
                                    </a>
                                    </div>
                                    <div className="product-detail">
                                    <h6><a href="#"><span>cotton top</span></a></h6>
                                ...
                                <div className="img-wrapper">
                                    <div className="front">
                                    <a href="#">
                                        <img src="../assets/images/fashion/product/13.jpg" className="img-fluid blur-up lazyload mb-1" alt="cotton top" />
                                    </a>
                                    </div>
                                    <div className="product-detail">
                                    <h6><a href="#"><span>cotton top</span></a></h6>
                                ...
                                <div className="img-wrapper">
                                    <div className="front">
                                    <a href="#">
                                        <img src="../assets/images/fashion/product/19.jpg" className="img-fluid blur-up lazyload mb-1" alt="cotton top" />
                                    </a>
                                    </div>
                                    <div className="product-detail">
                                    <h6><a href="#"><span>cotton top</span></a></h6>

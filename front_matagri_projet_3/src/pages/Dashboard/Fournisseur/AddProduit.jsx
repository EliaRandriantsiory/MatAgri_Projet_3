...
function AddProduit() {
                    ...
                    <form className="needs-validation add-product-form" noValidate onSubmit={handleSubmit}>
                        <div className="form">
                            <div className="col-md-6">
                                ...
                                <div style={{ display: 'flex', flexWrap: 'wrap', marginTop: '10px' }}>
                                    {imagePreviews.map((preview, index) => (
                                        <div
                                            key={index}
                                            style={{ display: 'flex', alignItems: 'center', marginBottom: '5px', marginRight: '10px' }}
                                        >
                            ...
                            <div className="form-group mb-3 row">
                                ...
                                <div className="col-xl-8 col-sm-7">
                                    <select className="form-select" aria-label="Default select example" value={categorie} onChange={(e) => setCategorie(e.target.value)}>
  ...
  <div className={`col-xl-8 col-sm-7 ${isValid && prix !== '' ? '' : 'has-error'}`}>
    ...
    {!isValid && prix !== '' && <div className="error-message">Veuillez entrer un prix valide.</div>}
  </div>
</div>
                           <div className="form-group mb-3 row">
  <label htmlFor="validationCustom05" className="col-xl-3 col-sm-4 mb-0">
    Stock du matériel :
  </label>
  <div className="col-xl-8 col-sm-7">
    <input
    ...
    />
    {stock !== '' && stock <= 0 && <div className="error-message">Veuillez entrer un stock valide.</div>}
  </div>
</div>
                            <div className="form-group mb-3 row">

            ...
            <div className="col-lg-12">
              ...
              <div className="theme-card">
                <form className="theme-form" onSubmit={handleOnclickSauvegarde}>
                  <div className="form-row row">
                    ...
                    <div className="col-md-6">
                      ...
                      <input
                        ...
                        required
                        onChange={(event) => handleOnChangeInputTextLastName(event)}
                      />
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-md-6">
                      ...
                      <input
                        ...
                        required
                        onChange={(event) => handleOnChangeInputTextAddress(event)}
                      />
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-md-6">
                      ...
                      <select id="region" onChange={handleOnChangeInputTextRegion}>
                      <option value="-------------">-------------</option>
                  ...
                  <input className="btn btn-solid w-auto" type="submit" value={"S'inscrire"}  />
                </form>
              </div>

  ...
  const handleAccept = () => {
    ...
    return(
      ...
      <a variant="Link" onClick={handleShow} style={{color: 'black',fontSize:'14px'}}>
        Termes et conditions d'utilisateurs
      </a>
...
<b style={{textAlign:'justify' ,fontSize:'14px'}}>ARTICLE 1</b> - Généralités
...
<br/><br/><b style={{textAlign:'justify' ,fontSize:'14px'}}>ARTICLE 2</b>- Commencement du terme de location et réception du matériel.
...
<br/><br/><b style={{textAlign:'justify' ,fontSize:'14px'}}>ARTICLE 3</b> - Acompte et paiement du loyer.
...
<br/><br/><b style={{textAlign:'justify' ,fontSize:'14px'}}>ARTICLE 4</b> - Entretien du matériel loué.
...
<br/><br/><b style={{textAlign:'justify' ,fontSize:'14px'}}>ARTICLE 5</b> - Fin de la location.
...
<br/> <br/><b style={{textAlign:'justify' ,fontSize:'14px'}}>ARTICLE 6</b> - Obligations spéciales du preneur.
...
<br/><br/><b style={{textAlign:'justify' ,fontSize:'14px'}}>ARTICLE 7</b> - Dénonciation du contrat.
...
<br/><br/><b style={{textAlign:'justify' ,fontSize:'14px'}}>ARTICLE 8</b> - Perte et assurance du matériel loué.
...
<br/><br/><b style={{textAlign:'justify' ,fontSize:'14px'}}>ARTICLE 9</b> - Tribunal compétent.

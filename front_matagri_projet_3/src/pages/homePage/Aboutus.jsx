        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-sm-12">
              ...
              >
                Notre plateforme est bien plus qu'un simple site de location et
                de livraison de matériels agricoles. Nous sommes engagés dans la
                résolution des défis cruciaux de l'autosuffisance alimentaire en
                favorisant l'expansion des terres cultivées et en facilitant la
                logistique collaborative par la mutualisation des équipements
                agricoles.
              </p>
              <br />
              <p
                ...
                style={{ textAlign: "justify", fontSize: 14 }}
              >
                En connectant les entreprises de location de matériels agricoles
                aux agriculteurs et coopératives, notre objectif est d'optimiser
                l'utilisation des ressources et de favoriser une collaboration
                étroite. Grâce à notre application intuitive, les agriculteurs
                peuvent accéder rapidement et efficacement aux équipements dont
                ils ont besoin, augmentant ainsi leur productivité tout en
                maximisant la rentabilité de leurs investissements.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="step-box">
                  <div>
                    ...
                    >
                      ...
                      <b> 12 %</b> en vous mutualisant pour la location du
                      matériel de votre choix, profitez-en !
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="step-box">
                  <div>
                    ...
                    <p
                      ...
                      style={{ textAlign: "justify", fontSize: 14 }}
                    >
                      Économisez jusqu'à <b>12 %</b> pour la location d'un
                      matériel agricole en tant que coopérative ! Rejoignez
                      notre plateforme pour profiter de cette offre.
                    </p>
                  </div>
                </div>
              </div>
